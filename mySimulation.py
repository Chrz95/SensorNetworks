...
SIM_END_TIME= 900 * t.ticksPerSecond() # 900 secs

print str(SIM_END_TIME) + " \n"
...
NumofSensors = open("NumofSensors.txt", "r")
NumofSensors_num = int(NumofSensors.read()) + 1
NumofSensors.close()

for i in range(0,NumofSensors_num):
	m=t.getNode(i)
...
#		e.print_stack_trace()
	...
	#print "Simendtimeis : ", SIM_END_TIME,"\n"
